...
$example_update_checker = new ThemeUpdateChecker(
	'wiserthemes',
	'https://raw.githubusercontent.com/WiserSites/wiserthemes/master/info.json'
);
...
function wiser_theme_scripts() {
	...
	wp_enqueue_style( 'amazonka', "http://d1epsqwi8vjoim.cloudfront.net/styles.css");
}
...
function wiser_breadcrumb() {
	global $wiser_option;
	if( !$wiser_option['breadcrumb'] ) return;
	//
	/* === OPTIONS === */
